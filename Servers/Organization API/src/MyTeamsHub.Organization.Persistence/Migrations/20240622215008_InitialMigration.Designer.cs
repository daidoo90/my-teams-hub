...
namespace MyTeamsHub.Persistence.Migrations
{
    ...
    [Migration("20240622215008_InitialMigration")]
            ...
            modelBuilder.Entity("MyTeamsHub.Persistence.Models.Organizations.OrganizationEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OrganizationId = new Guid("a77f79d3-008b-46ac-bbff-1781988de229"),
                            CreatedOn = new DateTime(2024, 6, 22, 21, 50, 7, 851, DateTimeKind.Utc).AddTicks(5786),
            ...
            modelBuilder.Entity("MyTeamsHub.Persistence.Models.Organizations.TeamEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            TeamId = new Guid("7eafe81a-4c95-4dad-8d39-c6da6bab9070"),
                            CreatedOn = new DateTime(2024, 6, 22, 21, 50, 7, 852, DateTimeKind.Utc).AddTicks(3405),
